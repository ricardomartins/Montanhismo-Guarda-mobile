...
sealed class UseCase(protected val dispatcher: CoroutineDispatcher) {
    ...
    abstract class Action(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
    ...
    abstract class Consumer<in P>(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
    ...
    abstract class BiConsumer<in P1, in P2>(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
    ...
    abstract class Supplier<out R>(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
    ...
    abstract class Function<in P, out R>(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
    ...
    abstract class BiFunction<in P1, in P2, out R>(dispatcher: CoroutineDispatcher) : UseCase(dispatcher) {
